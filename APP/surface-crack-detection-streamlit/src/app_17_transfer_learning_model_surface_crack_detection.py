# app_17_transfer_learning_model_surface_crack_detection.py
# Streamlit 앱 - Kaggle Surface Crack Detection - 콘크리트 표면 결함 분류
# 'Negative(정상)', 'Positive(비정상)'
...
def load_model():
    ...
    model_path = os.path.join("models", "model_transfer_learning_surface_crack_detection.pt") # - 학습된 모델 가중치 로드
...
# Streamlit UI
st.title("콘크리트 표면 결함 예측 분류기") # - 앱 제목
st.write("이미지를 업로드하면 콘크리트 표면 결함을 예측해줍니다!") # - 앱 설명
