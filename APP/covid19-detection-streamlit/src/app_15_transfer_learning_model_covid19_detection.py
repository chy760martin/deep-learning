# app_15_transfer_learning_model_covid19_detection.py
# Streamlit 앱 - Kaggle COVID19 Detection - COVID19 감염 예측 이미지 분류
...
def load_model():
    ...
    model_path = os.path.join("models", "model_transfer_learning_covid19_detection.pt") # - 학습된 모델 가중치 로드
...
# Streamlit UI
st.title("Covid 19 감염 분류기") # - 앱 제목
st.write("이미지를 업로드하면 Covid 19 감염을 예측해줍니다!") # - 앱 설명
