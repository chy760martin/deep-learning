# app_12_transfer_learning_model_model_brain_tumor.py
# Streamlit 앱 - Kaggle 뇌종양(Brain Tumor) 종류 분류
#     "glioma"(교조세포종): 성상세포(astrocytes)와 같은 뇌 실질 세포에서 발생하는 악성 종양
#     "meningioma"(수막종): 뇌와 척수를 둘러싸고 있는 수막에서 발생하는 종양, 일반적으로 양성 종양
#     "notumor"(종양 없음): 뇌종양이 없는 상태
#     "pituitary"(뇌하수체 종양): 뇌하수체에서 발생하는 종양, 일반적으로 양성 종양
...
# Streamlit UI
st.title("뇌종양 종류 분류기") # - 앱 제목
st.write("이미지를 업로드하면 AI가 뇌종양 종류를 예측해줍니다!") # - 앱 설명
